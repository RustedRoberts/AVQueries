# Queries
This repository hosts a collection of queries tailored for security products, including Microsoft Defender ATP and CrowdStrike. These crafted queries enable you to perform incident response, threat detection, and forensic investigation actions more effectively. No environment is the same, so I encourage you to explore, customize, and leverage these queries to suit your current needs.
...
# Platforms
Multiple platforms will be tailored for with a growing repository of queries and other resources as they are created, tested, tuned, and finalised.
